...
ConfigPath = "./Config/Utils/API/RVC.json"


class RVC_Config(Config):
    def __init__(self):
        initContent = {
            "host": "http://127.0.0.1",
            "port": 14100,
        ...
        JsonFileExist(Path=ConfigPath, initContent=initContent, logEnable=True, logInfo="【RVC支持】配置文件不存在，正在创建中。")
