...
ConfigPath = "./Config/Utils/API/Vits.json"
...
class VitsConfig(Config):
    def __init__(self):
        ...
        JsonFileExist(Path=ConfigPath, initContent=initContent, logEnable=True, logInfo="【Vits支持】配置文件不存在，正在创建中。")
